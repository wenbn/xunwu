...
public class HsMainHouseDaoImpl extends BaseDao implements HsMainHouseDao {
    ...
    @Override
    public int selectHouseCountByCondition(Map<Object, Object> condition) {
        return this.getSqlSession().selectOne("HsMainHouseDao.selectHouseCountByCondition",condition);
    }
}
