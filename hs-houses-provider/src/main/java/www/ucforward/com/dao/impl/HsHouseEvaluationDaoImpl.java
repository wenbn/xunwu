...
public class HsHouseEvaluationDaoImpl extends BaseDao implements HsHouseEvaluationDao {
    ...
    public int insertSelective(HsHouseEvaluation record) {
        return this.getSqlSession().insert("HsHouseEvaluationDao.insertSelective",record);
    }

    @Override
    public HsHouseEvaluation selectByPrimaryKey(Integer id) {
        return this.getSqlSession().selectOne("HsHouseEvaluationDao.selectByPrimaryKey",id);
    }

    @Override
    public int updateByPrimaryKeySelective(HsHouseEvaluation record) {
        return this.getSqlSession().update("HsHouseEvaluationDao.updateByPrimaryKeySelective",record);
    }
