...
public class HsMemberFinancialLoansApplyDaoImpl extends BaseDao implements HsMemberFinancialLoansApplyDao {
    ...
    public Map<Object, Object> selectListByCondition(Map<Object, Object> condition, int returnType) {
        String sql = "HsMemberFinancialLoansApplyDao.selectHsMemberFinancialLoansApplyMapByCondition";
        if(returnType != 0){
            sql = "HsMemberFinancialLoansApplyDao.selectHsMemberFinancialLoansApplyListByCondition";
        }
