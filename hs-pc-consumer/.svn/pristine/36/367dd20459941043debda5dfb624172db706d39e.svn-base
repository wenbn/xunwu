...
public interface ICommonManager {
    ...
    //获取频道详情
    ResultVo getChannelDetail(Integer id);
    ...
    //获取支持的城市信息详情
    ResultVo getCityDetail(Integer id);

    //修改支持的城市信息
    ResultVo updateCity(HsSupportCity city);

    //新增支持的城市信息
    ResultVo addCity(HsSupportCity city);

    //删除城市信息
    ResultVo deleteCity(Integer id);
