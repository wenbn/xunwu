...
public class HsOrderContract {
    ...
    /**
     * 保证金  有家具为总租金的百分之10 没家具为总租金的百分之5
     */
     ...
     * 合同附加条款
     */
    private JSONArray additionalTerms;
    ...
    /**
     * 区域信息
     * 0:Free Hold 1:Lease Hold
     */
    private Integer typeOfArea;
    ...
    public JSONArray getAdditionalTerms() {
        return additionalTerms;
    }

    public void setAdditionalTerms(JSONArray additionalTerms) {
    ...
    public Integer getTypeOfArea() {
        return typeOfArea;
    }

    public void setTypeOfArea(Integer typeOfArea) {
    ...
    public String getMemberMoble() {
        return memberMoble;
    }

    public void setMemberMoble(String memberMoble) {
        this.memberMoble = memberMoble;
    }
